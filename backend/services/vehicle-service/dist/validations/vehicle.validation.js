import { z } from "zod";
import { structuralDamage, TransmissionType, accidentType, ComponentCondition, VehicleStatus, } from "../models/vehicle.model.js";
...
export const vehicleDocumentSchema = (files) => {
...
export function validateVehiclePhotos(files) {
