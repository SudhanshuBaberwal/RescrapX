...
router.put("/document", uploadLimiter, attachUser, uploadVehicleDocument, uploadVehicleDocumentController);
router.get("/all-vehicles", attachUser, getAllVehicles);
router.put("/photos", uploadLimiter, attachUser, uploadVehiclePhotos, uploadVehiclePhotosController);
...
router.post("/partner/documents/upload", uploadLimiter, uploadVehicleDocumentByPartner, uploadPartnerDocument);
...
router.post("/partner/payments/proof", uploadLimiter, paymentProofUpload.single("paymentProof"), uploadPartnerPaymentProof);
...
router.post("/owner/accept-offer", uploadLimiter, uploadOwnerPaymentDocuments, acceptOfferAndSubmitPaymentDocuments);
